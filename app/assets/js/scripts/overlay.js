...
function isOverlayServerWhitelisted(server){
        ...
        htmlString += `<button class="serverListing" servid="${serv.rawServer.id}" ${serv.rawServer.id === giaSel ? 'selected' : ''}>
            ...
            <div class="serverListingDetails">
                ...
                <div class="serverListingInfo">
                    ...
                    ${isOverlayServerWhitelisted(serv) ? '<div class="serverListingWhitelist">Whitelist</div>' : ''}
                    ${serv.rawServer.mainServer ? '<div class="serverListingMainBadge">Principal</div>' : ''}
                </div>
            </div>
        </button>`
    }
